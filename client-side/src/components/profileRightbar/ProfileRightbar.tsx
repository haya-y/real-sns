      ...
      <div className='rightbarInfo'>
        ...
        <div className='rightbarInfo-followings'>
          ...
          <div className='rightbarInfo-followings-following'>
            <img src={IMAGE_FOLDER + '/person/1.jpeg'} alt='' className='rightbarInfo-followings-following-img' />
            <span className='rightbarInfo-followings-following-name'>Ken</span>
          </div>
          <div className='rightbarInfo-followings-following'>
            <img src={IMAGE_FOLDER + '/person/2.jpeg'} alt='' className='rightbarInfo-followings-following-img' />
            <span className='rightbarInfo-followings-following-name'>Yamaki</span>
          </div>
          <div className='rightbarInfo-followings-following'>
            <img src={IMAGE_FOLDER + '/person/3.jpeg'} alt='' className='rightbarInfo-followings-following-img' />
            <span className='rightbarInfo-followings-following-name'>Koga</span>
          </div>
          <div className='rightbarInfo-followings-following'>
            <img src={IMAGE_FOLDER + '/person/4.jpeg'} alt='' className='rightbarInfo-followings-following-img' />
            <span className='rightbarInfo-followings-following-name'>Matukubo</span>
          </div>
          <div className='rightbarInfo-followings-following'>
            <img src={IMAGE_FOLDER + '/person/5.jpeg'} alt='' className='rightbarInfo-followings-following-img' />
